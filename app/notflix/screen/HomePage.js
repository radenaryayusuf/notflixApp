...
import { Right, Content,Drawer, Footer, FooterTab,Icon,Button } from 'native-base'
...
const HEADER_SCROLL_DISTANCE = HEADER_MAX_HEIGHT - HEADER_MIN_HEIGHT;
 ...
 class HomePage extends Component {
  ...
  gotoPlay() {
    this.props.navigation.navigate('trailerAqua')
  }
  render() {
          ...
          <View style={styles.scrollViewContent}>     
            <Content padder>
                ...
                
              {
                ...
                {
                  this.props.newrelease.isLoading ? <ActivityIndicator/>:
            ...
            <View style={{justifyContent:"center",alignItems:"center",paddingTop:0}}>
              ...
              <View style={{flex: 1, backgroundColor: 'transparent'}}>
                ...
                {
                  this.props.mostpopular.isLoading ? <ActivityIndicator/>:
