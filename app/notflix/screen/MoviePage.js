...
const HEADER_SCROLL_DISTANCE = HEADER_MAX_HEIGHT - HEADER_MIN_HEIGHT;
 ...
 class MoviePage extends Component {
  ...
  gotoPlay(id) {
    this.props.navigation.navigate('Videocomp', {id})
  }
  componentDidMount() {
    ...
    return (
      ...
      <View style={{backgroundColor: '#0C0C0C', flex:1}}>
        ...
        >
          ...
          <List>
            <ListItem  onPress={ () => {this.gotoPlay(this.state.idmovie)}} style={{borderBottomWidth:0, marginLeft:0}}>
            <Left>
               <Image 
               source={{uri:this.props.getmovie.isLoading ? 'Loading'  : this.props.getmovie.data[0].image}}
               style={{
