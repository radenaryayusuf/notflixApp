...
export function newRelease(){
    ...
    return {
        type: 'NEW_RELEASE',
        payload: axios.get('http://www.animedemy.me:4441/api/v1/movies/cached/trending/4')
    }
}
export function mostRated(){
    ...
    return {
        type: 'MOST_RATE',
       payload: axios.get('http://www.animedemy.me:4441/api/v1/movies/popular/4')
    }
}
...
export function GET_MOVIE(id){
    return {
        type: "GET_MOVIE",
        payload: axios.get(`http://www.animedemy.me:4441/api/v1/movie/${id}`)
    }
}
export function GET_CATEGORY(name){
    return {
        type: "GET_CATEGORY",
        payload: axios.get(`http://www.animedemy.me:4441/api/v1/movies/${name}/4`)
    }
}
export function SEARCH_MOVIE(text) {
    return {
        type: "SEARCH_MOVIE",
        payload: axios.get(`http://www.animedemy.me:4441/api/v1/movies/search?q=${text}`)
    }
}
export function CATE_LIST(){
    // data simulation
   

    return {
        type: 'CATE_LIST',
       payload: axios.get('http://www.animedemy.me:4441/api/v1/movies/categories')
    }
}